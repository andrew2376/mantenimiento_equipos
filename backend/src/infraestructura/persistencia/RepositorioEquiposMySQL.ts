...
export class RepositorioEquiposMySQL implements EquipoRepository {
  ...
  async crear(equipo: Equipo): Promise<Equipo> {
    ...
    return await this.obtenerPorId(resultado.insertId) as Equipo
  }
  ...
  async actualizar(equipo: Equipo): Promise<Equipo> {
    ...
    return await this.obtenerPorId(equipo.id) as Equipo
  }
